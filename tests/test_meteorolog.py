...
class CTestMeterolog(TestCase):
    ...
    def test_parse_weather(self):
        ...
        result: str = ("Темп.: 15  -  30 °C,  давл.: 690 - 719 мм.рт.ст.,  влажн.: 70 - 100 %,"
                       "  ветер: 10 м/с сев.  - 40 м/c юг  Ясно. \u2600\ufe0f Облачно. \u2601 ")
...
#AssertionError: 'Темп[28 chars] - 719 мм.рт.ст.,  влажн.: 70 - 100 %,  ветер:[43 chars]. ☁ ' != 'Темп[28 char
#- Темп.: 15  -  30 °C,  давл.: 690 - 719 мм.рт.ст.,  влажн.: 70 - 100 %,  ветер: 10 м/с сев.  - 40 м/c юг  Яс
#+ Темп.: 15  -  30 °C,  давл.: 690 - 710 мм.рт.ст.,  влажн.: 70 - 100 %,  ветер: 10 м/с сев.  - 40 м/c юг Ясн
#?
